...
const Footer = () => {
  return (
    <div>
      <footer className="footer xl:px-24 py-10 px-4 bg-base-200 text-base-content">
        <aside>
        <img src='/logo.png' alt='Logo' style={{ width: '300px', height: '100px' }} />
          <p className='my-5 md:w-40'>
            Indulge in the sweetest treats and savor the joy in every scoop at ChamaBikes.
          </p>
        </aside> 
        <nav>
